...
$spp_settings->url_rewrites = array( 
    'read' => array('separator' => '-', 'rule' => 'has/(.*)', 'index' => 1, 'permalink' => 'has/{{ term }}' ), //0
