...
<?php if ( is_search() || is_tag() ) : ?><link rel="canonical" href="<?php bloginfo('url');?>/apa/<?php $ab=strtolower($s); echo str_replace(' ', '-',$ab); ?>/" />
...
<div id="sormatamu">
<div id="mooning">
<div id="mooning-kirteng">
</div>
<div id="mooning-kiwkan">
</div>
<center>
